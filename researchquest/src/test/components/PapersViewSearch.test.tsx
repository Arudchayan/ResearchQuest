...
vi.mock('../entities/AddPaperView', () => ({ AddPaperView: () => <div>AddPaperView</div> }))
vi.mock('../entities/PaperDetailView', () => ({ PaperDetailView: () => <div>PaperDetailView</div> }))
vi.mock('../layout/OnboardingGuide', () => ({ OnboardingGuide: () => <div>OnboardingGuide</div> }))
vi.mock('./PaperCard', () => ({ PaperCard: ({ paper }: any) => <div>{paper.title}</div> }))
