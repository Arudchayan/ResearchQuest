...
export function TopicSelector({ entityId, entityType }: TopicSelectorProps) {
  ...
  const existingTopicSelectId = useId();
  const newTopicInputId = useId();
  ...
  return (
    <div className="bg-bg-surface border border-border-subtle rounded-lg p-4 space-y-3">
      ...
      {availableTopics.length > 0 && (
        <div>
          <label htmlFor={existingTopicSelectId} className="block text-caption text-text-secondary mb-1">
            Add an existing topic
          </label>
          <div className="flex gap-2">
            <select
              id={existingTopicSelectId}
      ...
      <div className="pt-3 border-t border-border-subtle">
        <label htmlFor={newTopicInputId} className="block text-caption text-text-secondary mb-1">
