...
import { disableDemoModeAndReload, supabase } from "../../lib/supabase";
...
export function TopicDetailView({
  ...
  /** Demo first-run coachmark + exit — the topic renders the full workspace shell. */
    ...
    <>
      ...
      {isFirstRunTopic && (
        <section
          ...
          className="rounded-xl border border-border-subtle bg-bg-surface p-4 shadow-sm sm:p-6"
        >
          ...
          <div className="mt-4">
            <OnboardingGuide storageKey="rq_demo_onboarding_complete" />
          </div>
        </section>
      )}
