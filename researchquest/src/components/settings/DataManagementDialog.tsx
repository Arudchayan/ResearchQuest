...
import { bulkDeleteCopy } from "../../utils/deleteModel";
...
export function DataManagementDialog({ open, onClose }: DataManagementDialogProps) {
  ...
  return <><Dialog.Root open={open} modal={!showClearConfirm} onOpenChange={(isOpen) => !isOpen && onClose()}><Dialog.Portal>
    ...
    <ConfirmDialog isOpen={showClearConfirm} onClose={() => setShowClearConfirm(false)} onConfirm={clearAllData} {...bulkDeleteCopy()} variant="danger" isLoading={isClearing} />
  </>;
}
