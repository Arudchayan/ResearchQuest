          ...
          <div className="px-6 py-6 space-y-6">
            <section className="grid gap-4 md:grid-cols-2">
              <div className="p-4 rounded-xl border border-border-subtle bg-bg-base">
                ...
                <p className="text-caption text-text-secondary mb-4">
                  Level {currentLevel} · {xpIntoCurrentLevel} XP into the level
                  ·{" "}
                  {xpToNextLevel > 0
                    ...
                    >
                      <div>
                        ...
                        <p className="text-caption text-text-tertiary">
                          Total XP needed: {snapshot.xpRequired}
                        </p>
                      </div>
                      <Trophy
              ...
              <div className="p-4 rounded-xl border border-border-subtle bg-bg-base">
                ...
                <p className="text-caption text-text-secondary mb-4">
                  These actions give the biggest momentum boosts. Stack them to
                  level up faster.
                </p>
            ...
            <section className="p-4 rounded-xl border border-border-subtle bg-bg-base">
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm text-text-secondary">
                <li>
                  Log a note or idea update after each focus sprint to convert
                  insights into XP.
                </li>
                <li>
                  Advance task stages before ending the day to protect streaks
                  and unlock bonus XP.
                </li>
                <li>
                  Link notes, papers, and ideas with topics to earn small bursts
                  that add up quickly.
                </li>
              </ul>
            </section>
