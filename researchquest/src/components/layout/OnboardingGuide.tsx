...
const STEPS = [
  {
    ...
    description: 'Use the quick-add buttons in Notes and Ideas to capture sparks without leaving your current flow.',
    icon: NotebookPen,
  },
  {
    title: 'Link your research',
    description: 'Attach topics and papers to each note or idea so Focus Studio can suggest the best next sprint.',
    icon: Target,
  },
  {
    title: 'Review the dashboard',
    description: 'Check the left sidebar for streaks, XP boosts, and suggested next actions before diving in.',
    icon: Compass,
  },
]

export function OnboardingGuide({ storageKey = DEFAULT_STORAGE_KEY }: OnboardingGuideProps) {
      ...
      <div className="flex items-start gap-4 p-5 sm:p-6">
        ...
        <div className="flex-1 space-y-2">
          <div className="flex items-start justify-between gap-2">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wide text-primary-500">Welcome to ResearchQuest</p>
