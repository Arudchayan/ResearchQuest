...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-text-primary text-bg-base shadow hover:opacity-95",
        destructive:
          "bg-coral text-bg-base shadow-sm hover:bg-coral-strong",
        outline:
          "border border-border-moderate bg-bg-surface text-text-primary shadow-sm hover:bg-bg-elevated",
        secondary:
          "bg-bg-elevated text-text-primary shadow-sm hover:bg-bg-muted",
