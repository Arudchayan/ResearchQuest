    ...
    <div className="min-h-full bg-bg-base p-4 sm:p-6 lg:p-8">
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        <PageHeader
          ...
          description="Source and RSS management is not fully shipped yet. Inbox items still appear here even without a linked source."
          actions={
            <button
              type="button"
        ...
        <section className="surface-card p-4 sm:p-5" aria-label="Feed filters">
        ...
        <section aria-label="Feed items">
          ...
          {loading ? (
            ...
            <div className="surface-card p-6 text-text-secondary">{error}</div>
          ) : items.length === 0 ? (
            <div
              role="status"
              aria-live="polite"
