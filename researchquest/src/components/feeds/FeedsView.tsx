  ...
  return (
    ...
    >
      ...
      <p className="mx-auto mt-2 max-w-md text-small text-text-secondary">
        Source and RSS management is not shipped yet, so this inbox stays
        empty until ingest is connected. Existing orphan items without a
        source are not shown and are not deleted. The rest of the workspace —
...
export function FeedsView() {
  ...
  const checkingSources = sourceCount === null;
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        ...
        {checkingSources ? (
          <div className="space-y-3" role="status" aria-live="polite">
            ...
            <span className="sr-only">Checking feeds availability</span>
          </div>
        ) : !ingestReady ? (
          <AlphaEmptyState />
        ) : (
          <>
            ...
            >
              <div className="space-y-4">
                <div>
                  <h2 className="section-kicker">Type</h2>
