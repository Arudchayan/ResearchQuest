    ...
    <div className="min-h-screen flex items-center justify-center bg-bg-base">
      <div className="w-full max-w-md p-8 bg-bg-surface rounded-lg shadow-lg border border-border-subtle">
        ...
        <form onSubmit={handleAuth} className="space-y-4">
          ...
          {message && (
            <div
              className={`p-3 rounded-md text-small ${
                ...
                {papers.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-caption text-text-tertiary">
                      Use the "New Paper" button in the left sidebar to add
                      papers by DOI or search.
                    </p>
                  </div>
                ) : (
                  <div className="grid gap-6 md:grid-cols-2">
                    {papers.map((paper) => (
                      <div
                        key={paper.id}
                        className="p-6 bg-bg-surface rounded-lg border border-border-subtle"
                      >
                        ...
                        <span
                          className={`inline-block px-2 py-1 rounded-full text-caption ${
                            paper.status === "Read"
              ...
              <div className="max-w-4xl mx-auto">
                {ideas.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-caption text-text-tertiary">
                      Use the "New Idea" button in the left sidebar to add your
                      first idea.
                    </p>
                  </div>
                ) : (
